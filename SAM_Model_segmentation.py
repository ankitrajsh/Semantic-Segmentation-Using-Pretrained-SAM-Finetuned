...
image_dir = "G:/Filtered_Green_Train_Images1 - Copy"
mask_dir = "G:/Filtered_Green_Images1 - Copy11"
...
# Create a custom dataset class for the SAM model
...
# torch.save(model.state_dict(), "G:\sernetdata\model_ne_datasets_4.pth")

############################################################################################################
#training with dice and iou score
# Define Dice Coefficient and IoU score functions
